...
{
    /// <inheritdoc />
    public partial class Migration_01192025 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(max)", maxLength: 100, nullable: false),
                    CanBePublished = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DomainUsers_AspNetRoles_ApplicationUserRoleId",
                        column: x => x.ApplicationUserRoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DomainUsers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DomainUsers_Images_ProfilePhotoId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(750)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DomainUsers_ApplicationUserRoleId",
                table: "DomainUsers",
                column: "ApplicationUserRoleId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DomainUsers_ProfilePhotoId",
                table: "DomainUsers",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_BlogPosts_DomainUsers_AuthorId",
                table: "BlogPosts",
                column: "AuthorId",
                principalTable: "DomainUsers",
                principalColumn: "Id");
