        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_DomainUsers_DomainUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Readers_DomainUsers_Id",
                        column: x => x.Id,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserRoleEndpoint_Endpoints_EndpointsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Authors_DomainUsers_Id",
                        column: x => x.Id,
                        principalTable: "DomainUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailForBlogPostId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Images_BlogPosts_ThumbnailForBlogPostId",
                        column: x => x.ThumbnailForBlogPostId,
                        principalTable: "BlogPosts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_DomainUserId",
                table: "AspNetRoles",
                column: "DomainUserId",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_ThumbnailForBlogPostId",
                table: "Images",
                column: "ThumbnailForBlogPostId",
                unique: true,
                filter: "[ThumbnailForBlogPostId] IS NOT NULL");
